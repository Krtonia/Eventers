package com.example.eventer.ui.auth
...
fun SignIn(navController: NavController) {
    ...
    Column(
        ...
        TextField(
            ...
            leadingIcon = {
                Icon(painter = painterResource(R.drawable.mail), contentDescription = "email", tint = Color.White)
            },
        ...
        TextField(
            ...
            leadingIcon = { Icon(painter = painterResource(R.drawable.lock), contentDescription = "password lock icon", tint = Color.White)},
            trailingIcon = {
